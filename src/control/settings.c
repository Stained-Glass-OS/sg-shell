...
static const struct category CATS[] = {
    ...
    { L"Ease of Access", L"Text size, keyboard, mouse pointer", IC_G_EOA,
      { PG_S_EOA_DISPLAY, PG_S_EOA_KEYBOARD, PG_S_EOA_MOUSE, PG_COUNT } },
...
static const struct { const WCHAR *uri; enum page_id page; } URIS[] = {
    ...
    { L"easeofaccess-mouse", PG_S_EOA_MOUSE }, { L"easeofaccess-cursorandpointersize", PG_S_EOA_MOUSE },
