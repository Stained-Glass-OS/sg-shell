...
#define C_ACCENT_LT (sgm_dark ? RGB(74,46,110) : RGB(231, 222, 246))
#define C_HOVER (sgm_dark ? RGB(52,44,64) : RGB(242, 237, 250))
#define C_HEAD (sgm_dark ? RGB(190,150,240) : RGB(80, 30, 150))
#define C_WARN_BG (sgm_dark ? RGB(70,60,20) : RGB(255, 244, 206))
...
int resmon_main(void);                       /* Resource Monitor (resmon.exe) */
